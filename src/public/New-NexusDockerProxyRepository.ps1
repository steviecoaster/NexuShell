function New-NexusDockerProxyRepository {
    ...
    .NOTES
    #>
    [CmdletBinding(HelpUri = 'https://github.com/steviecoaster/TreasureChest/blob/develop/docs/New-NexusDockerHostedRepository.md',DefaultParameterSetName = "Default")]
    Param(
        [Parameter(Mandatory)]
        [String]
        $Name,
