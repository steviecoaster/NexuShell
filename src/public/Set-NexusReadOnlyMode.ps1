function Set-NexusReadOnlyMode {
    ...
    #>
    [CmdletBinding(HelpUri='https://github.com/steviecoaster/TreasureChest/blob/develop/docs/Set-NexusReadOnlyMode.md',SupportsShouldProcess, DefaultParameterSetName = "Enable", ConfirmImpact = 'High')]
    Param(
